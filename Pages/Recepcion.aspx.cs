    ...
    public partial class Recepcion : System.Web.UI.Page
    {
        ...
        protected void OnRowCommand(object sender, GridViewCommandEventArgs e) 
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                int nroservi= Convert.ToInt32(row.Cells[1].Text);
                ...
                selectadapter.Read();
                int selectedvalueequi = Convert.ToInt32(selectadapter["idequi"])-1;
                int selectedvaluemarca = Convert.ToInt32(selectadapter["idmar"])-1;
        ...
        Conexion conexionesDB = new Conexion();
        private void recuperarinfo()
        {
            gvrecepcion.DataSource = conexionesDB.obtenerinfo(Busquedainteractiva.Text);
            gvrecepcion.DataBind();
        }

        protected void btnbusquedaibteractiva_Click(object sender, EventArgs e)
        {
            recuperarinfo();
        }
