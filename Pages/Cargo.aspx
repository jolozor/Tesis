<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="Cargo.aspx.cs" Inherits="Tesis.Pages.Cargo" %>
    ...
    <form runat="server" class="mb-3">
        ...
        <div class="mx-auto" style="width:500px">
            ...
            <div class="col-md">
                    <div class="form-floating mb-3">
                        <asp:TextBox type="text" class="form-control" ID="inputcargo" runat="server" placeholder="Cargo"></asp:TextBox>
        ...
        <div class="container row" >
            <div class="table small" >
                <asp:GridView runat="server" id="gvcargos" class="table-sm table-borderless table-hover" HorizontalAlign="Center">
                    <Columns>
