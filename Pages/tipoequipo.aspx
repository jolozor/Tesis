<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="tipoequipo.aspx.cs" Inherits="Tesis.Pages.tipoequipo" %>
    ...
    <form runat="server" class="mb-3">
        ...
        <div class="container row">
            <div class="table small">
                <asp:GridView runat="server" id="gvtipoequipo" class="table-sm table-borderless table-hover" HorizontalAlign="Center">
                    <Columns>
