    ...
    public partial class Recepcion : System.Web.UI.Page
    {
        ...
        protected void OnRowCommand(object sender, GridViewCommandEventArgs e) 
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                Int32 nroservi= Convert.ToInt32(row.Cells[1].Text);
                ...
                selectadapter.Read();
                int selectedvalueequi = Convert.ToInt32(selectadapter["idequi"]);
                int selectedvaluemarca = Convert.ToInt32(selectadapter["idmar"]);

                ComboBox1.SelectedIndex = selectedvalueequi;
                ComboBox2.SelectedIndex = selectedvaluemarca;
